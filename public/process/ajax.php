...
function registerBillAndSend() {
    ...
    //return '{"result":"' . $$name . '"}';
	$pay_button_link = "https://bocamx.com/pages/payonline.php?inv={$_REQUEST['inv_number']}-{$bill_id}&amt={$_REQUEST['inv_total']}&reg={$_REQUEST['registration']}";
...
$html_message
        ...
        <table>
            <tr style="border-bottom: 1px solid gray; font-weight: bold;">
            	<td width="55%"><span class="siglabel">Authorized by: {$_REQUEST['customer_name']}</span><br><img class="sig" src="{$file_root}sigs/{$invoice}" alt="{$signatureAlt}" /></td>
